...
# openai.api_key = "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"
...
def organicfarming(request):
    return render(request, 'mysite/organicfarming.html')
